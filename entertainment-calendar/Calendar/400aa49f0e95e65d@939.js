...
function _4(Calendar,dji,convert2UTCdate,weekday,width){return(
Calendar(dji, {
  x: d => convert2UTCdate(d.date),
  y: d => d.festival,
  weekday,
  width
})
...
function _6(Calendar,dji,convert2UTCdate,weekday,width){return(
Calendar(dji, {
  x: d => convert2UTCdate(d.date),
  y: d => d.sport_event,
  weekday,
...
function _8(Calendar,dji,convert2UTCdate,weekday,width){return(
Calendar(dji, {
  x: d => convert2UTCdate(d.date),
  y: d => d.overall,
  weekday,
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["Calendar","dji","convert2UTCdate","weekday","width"], _4);
  main.variable(observer()).define(["md"], _5);
  main.variable(observer()).define(["Calendar","dji","convert2UTCdate","weekday","width"], _6);
  main.variable(observer()).define(["md"], _7);
  main.variable(observer()).define(["Calendar","dji","convert2UTCdate","weekday","width"], _8);
